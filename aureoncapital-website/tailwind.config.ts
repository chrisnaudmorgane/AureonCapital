...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // AureonCapital brand colors
        'aureon-gold': designTokens.colors.primary,
        'aureon-blue': designTokens.colors.secondary,
        'aureon-dark': designTokens.colors.background,
        'aureon-white': designTokens.colors.text,
        'aureon-accent': designTokens.colors.accent,
        'aureon-glass': designTokens.colors.glass,
        
        // Extended color palettes
        gold: designTokens.colors.gold,
        'aureon-blue-palette': designTokens.colors.blue,
      ...
      fontFamily: {
        satoshi: designTokens.fonts.primary,
